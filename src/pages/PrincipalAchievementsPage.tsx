...
const PrincipalAchievementsPage: React.FC = () => {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-gray-600">View and manage achievements across all departments</p>
            </div>
...
export default PrincipalAchievementsPage; 